...
public final class GymificDatabase_Impl extends GymificDatabase {
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoWorkoutTable.equals(_existingWorkoutTable)) {
          return new RoomOpenHelper.ValidationResult(false, "workout_table(com.ersiver.gymific.model.Workout).\n"
                  + " Expected:\n" + _infoWorkoutTable + "\n"
        ...
        if (! _infoCategoryTable.equals(_existingCategoryTable)) {
          return new RoomOpenHelper.ValidationResult(false, "category_table(com.ersiver.gymific.model.WorkoutCategory).\n"
                  + " Expected:\n" + _infoCategoryTable + "\n"
