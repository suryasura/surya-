...
public class CategoryViewItemBindingImpl extends CategoryViewItemBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.category == variableId) {
            setCategory((com.ersiver.gymific.model.WorkoutCategory) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setCategory(@Nullable com.ersiver.gymific.model.WorkoutCategory Category) {
    ...
    protected void executeBindings() {
        ...
        com.ersiver.gymific.model.WorkoutCategory category = mCategory;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.ersiver.gymific.util.BindingUtilsKt.bindImage(this.categoryImage, categoryId);
