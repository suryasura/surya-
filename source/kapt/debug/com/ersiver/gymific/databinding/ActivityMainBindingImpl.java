...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {1},
            new int[] {com.ersiver.gymific.R.layout.content_main});
    ...
    private ActivityMainBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.ersiver.gymific.databinding.ContentMainBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeContent((com.ersiver.gymific.databinding.ContentMainBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeContent(com.ersiver.gymific.databinding.ContentMainBinding Content, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
