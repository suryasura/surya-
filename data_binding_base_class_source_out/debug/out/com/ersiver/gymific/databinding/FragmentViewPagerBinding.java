...
public abstract class FragmentViewPagerBinding extends ViewDataBinding {
  @NonNull
  public final AppBarLayout appBarWorkout;
  ...
  @NonNull
  public final Toolbar toolbarWorkout;

  protected FragmentViewPagerBinding(Object _bindingComponent, View _root, int _localFieldCount,
      AppBarLayout appBarWorkout, ViewPager2 pager, TabLayout tabLayout, Toolbar toolbarWorkout) {
    super(_bindingComponent, _root, _localFieldCount);
    this.appBarWorkout = appBarWorkout;
    this.pager = pager;
    this.tabLayout = tabLayout;
    this.toolbarWorkout = toolbarWorkout;
  }
